...
export const TAG_TO_TOPIC_KEYS = {
  ...
  testing: ['engineering-architecture'],
 ...
 */
/** Article kicker: drop inferred format pills; topic/category chips stay elsewhere. */
export function enhanceInsightArticleFormatPill($) {
  if (($('body').attr('data-nf-layout') || '') !== 'insight-article') return;
  $('[data-nf-insight-format-pill]').remove();
}
