...
_ITER8_DESKTOP_NAV = (
    ...
    'href="insights-explore-iter8-engineering.html">Communities</a></li>'
)
...
_ITER9_DESKTOP_NAV = (
    ...
    'transition-colors duration-200 ease-in-out" href="insights-explore-iter9-engineering.html">Communities</a>'
    "</div></div></div></li>"
)
...
_ITER9_MOBILE_NAV = (
    ...
    'href="insights-explore-iter9-engineering.html">Communities</a></li>'
)
...
def patch_iter789_insights_hero_engineering_jump(html: str, *, iteration: str) -> str:
    ...
    new = (
        ...
        '<span class="nf-insights-jump-to-community__label">Communities →</span></a>'
    )
    if old not in html:
...
_ITER89_ENGINEERING_HERO_SUBTEXT = (
    ...
    "Tutorials, performance notes, protocol walkthroughs and open source releases from people across "
    "Nearform communities, shipping in production. Practical detail you can lift into your own systems and repos.</p>"
)
...
_H1_ENGINEERING_ITER789 = (
    ...
    '<span class="sr-only select-none">Communities</span>'
    '<span class="absolute w-full z-10" aria-hidden="true">'
    "<span>C</span><span>o</span><span>m</span><span>m</span><span>u</span><span>n</span><span>i</span>"
    "<span>t</span><span>i</span><span>e</span><span>s</span>"
    "</span>"
...
_ENG_ITER89_HUB_TOPIC_TAB_BUTTONS = (
    ...
    'class="nf-insights-topic-tabs__tab">Communities practices</button>'
)

_ENG_ITER89_TOPIC_TABLIST = (
    '<div role="tablist" aria-label="Browse technical articles by topic" class="nf-insights-topic-tabs__list">'
    + _ENG_ITER89_HUB_TOPIC_TAB_BUTTONS
    + "</div>"
)
...
_ARTICLE_EXPLORE_GATE_INSIGHTS = (
    ...
    "</div>"
    '<div class="nf-article-explore-gate__path">'
    '<h3 class="nf-article-explore-gate__path-h">Communities</h3>'
    "<p class=\"nf-article-explore-gate__path-p\">Technical deep-dives and tutorials for practitioners</p>"
    '<a target="_self" class="'
    + _ARTICLE_GATE_BTN_CLASSES
    + ' nf-article-explore-gate__cta" href="insights-explore-iter8-engineering.html">Browse Communities →</a>'
    "</div></div></div></section>"
)
