...
(function () {
  ...
  var HERO_INSIGHTS = {
    ...
    title: 'Moving beyond the hype: Communities for the AI era',
    img:
  ...
  function insertFeaturedHero(hero) {
    ...
    el.innerHTML =
      ...
      (H.format
        ? '<span class="nf-explore-iter7-featured__fmt">' + H.format + '</span>'
        : '') +
      '</span>' +
  ...
  function communityCardHtml(c) {
    return (
      ...
      (c.format ? '<span class="nf-explore-iter7-ec__fmt">' + c.format + '</span>' : '') +
  ...
  function replaceEngineeringCommunityModule() {
    ...
    mod.innerHTML =
      ...
      '<p class="nf-explore-iter7-ec__sub">Deep-dives, tutorials and open source releases from our communities.</p>' +
      '</header>' +
      '<div class="nf-explore-iter7-ec__grid">' +
